        ...
        <div className='page-container'>
            <motion.div
                ...
                <div className='bio-box'>
                    <h2 className='name-title'>Richard Rosenberg</h2>
                    <h3 className='sub-title'>Junior Full Stack Developer</h3>
                    <h3 className='sub-title'>Email: richard.rosenberg.1987@gmail.com</h3>
                    <br />
                    <h3>Summary</h3>
                    <p>
                        ...
                        Never miss a day of work in over 15 years.
                    </p>
                    <br />
                    <h3>Skills</h3>
                    <p>
            ...
            <div className='image-box-resume'>
                <motion.div
                    animate={{ scale: 0.3 }}
                    initial={{ scale: 0 }}
                    transition={{ duration: 1.5 }}>
